...
#
#     return result
def main(query,apikey, save_path='/home/nvidia/aws_hackathon_demo/process_chart', llm_model="deepseek-ai/deepseek-r1", embedding_model="baai/bge-m3", vector_db_path="/home/nvidia/aws_hackathon_demo/vdb"):
